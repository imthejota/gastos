    ...
    <>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <fieldset>
          ...
          {errors && errors.tipo && <output>{errors.tipo.message}</output>}
        </fieldset>
        <fieldset>
          ...
          />
          {errors && errors.nombre && <output>{errors.nombre.message}</output>}
        </fieldset>
        <fieldset>
          ...
          {errors && errors.categoria && <output>{errors.otra.message}</output>}
        </fieldset>
        <fieldset>
          ...
          />
          {errors && errors.valor && <output>{errors.valor.message}</output>}
        </fieldset>
